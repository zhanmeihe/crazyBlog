...
<head>
   ...
   <link href="<%=request.getContextPath()%>/images/logo.ico"
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/css/common.css?v=1.5.1"/>
    <!--[if lt IE 9]>
	...
	<link rel="stylesheet" href="<%=request.getContextPath()%>/css/loginnew.css?v=1.5.1"/>
	 <script type="text/javascript" charset="utf-8" src="<%=request.getContextPath()%>/js/pass.js?v=1.5.1"></script>  
      ...
      <div class="login_r_wrap">
        <div class="login_c regist_c">
          ...
          <div class="login_c_c regist_c_c">
            ...
            <form id="handleform" action="<%=request.getContextPath()%>/Userinfo/blogRegistr" method="post" onsubmit="return validateForm();">
              <ul class="step2_list">  
                <li>
                  <input type="text" class="iphone" id="name" name="userName" placeholder="输入手机号"> 
                   
                </li>
                <li>
                  <input type="text" placeholder="用户名" id = "nickn" class="nickname" name="nickNmae" value=""> 
                </li>
               <!--  <li>
                  <input type="text" placeholder="邮箱" class="re_email" name="email" value=""> 
                </li> -->
                <li>
                  <input type="password" placeholder="输入密码" class="re_password" id="pass"  name="passWord"> 
                </li>
                <li>
                  <input type="password" placeholder="再次输入密码" class="re_password_again" id="pass2" name="confirmpassword"> 
                ...
                <p>
						<label></label> <input class="code" placeholder="附加码" name="checkCode"
							id="checkCode" type="text" size="15" /> <span><img
							id="image" src="<%=request.getContextPath()%>/Checkimage"
							onclick="randCode(this);" alt="" width="110" height="60" style="" /></span>
					</p>
              </ul>
              <!-- <input type="hidden" name="fkid" id="fkid" value="" /> -->
              <input id="regist" accesskey="l" value="注册提交" tabindex="6" type="submit" class="next_btn regist">
              <!-- data-kuick='{"act":"csdn06","desc":"下一步:提交注册信息"}' -->
            </form>
          </div>
        </div>
        <div class="login_copyright">All Rights Reserved 版权所有：<a href="http://www.pioneersv.cn">占美和个人博客</a>
						备案号：京ICP备17010763号</div>
      </div>
    </div>
  </body>
